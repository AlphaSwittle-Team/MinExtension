...
public class ModelDiamondGolem extends ModelBase {
	/**
	...
	public ModelDiamondGolem(float par1)
	{
		this(par1, -7.0F);
	}

	public ModelDiamondGolem(float par1, float par2)
	{
		short short1 = 128;
		short short2 = 128;
	...
	{
		EntityDiamondGolem entityirongolem = (EntityDiamondGolem) par1EntityLivingBase;
