...
public class EntityAIGoldGolemLookAtVillager extends EntityAIBase {
	private EntityGoldGolem theGolem;
	private EntityVillager theVillager;
	private int lookTime;
	private static final String __OBFID = "CL_00001602";

	public EntityAIGoldGolemLookAtVillager(EntityGoldGolem par1EntityGoldGolem)
	{
		this.theGolem = par1EntityGoldGolem;
		this.setMutexBits(3);
	}
