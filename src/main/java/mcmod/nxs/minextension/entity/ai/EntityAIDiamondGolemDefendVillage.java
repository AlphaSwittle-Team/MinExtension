...
public class EntityAIDiamondGolemDefendVillage extends EntityAITarget {
	EntityDiamondGolem irongolem;
	/**
	...
	public EntityAIDiamondGolemDefendVillage(EntityDiamondGolem par1EntityDiamondGolem)
	{
		super(par1EntityDiamondGolem, false, true);
		this.irongolem = par1EntityDiamondGolem;
		this.setMutexBits(1);
	}
